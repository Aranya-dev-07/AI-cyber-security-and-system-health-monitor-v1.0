...
const S = {
  ...
  header: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 28px', background: 'linear-gradient(90deg, #E8E4F4 0%, #E4EDD8 100%)', borderBottom: '1px solid var(--border)', position: 'sticky', top: 0, zIndex: 10, boxShadow: 'var(--shadow)' },
  headerTitle: { fontWeight: 700, fontSize: 15, color: 'var(--text)' },
  logoMark: { width: 36, height: 36, borderRadius: 10, background: 'linear-gradient(135deg, var(--lavender) 0%, var(--olive) 100%)', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, fontWeight: 700 },
  ...
  gaugeCard: { background: 'linear-gradient(145deg, var(--surface) 60%, #EBE6F8 100%)', borderRadius: 'var(--radius)', padding: '20px 16px 16px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6, boxShadow: 'var(--shadow)', border: '1px solid var(--border)' },
  ...
  stripItem: { background: 'linear-gradient(160deg, var(--surface) 0%, var(--surface-2) 100%)', padding: '12px 16px', display: 'flex', flexDirection: 'column', gap: 4 },
