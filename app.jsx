...
// ─── Styles ───────────────────────────────────────────────────────────────────
const S = {
  root: { minHeight: '100vh', display: 'flex', flexDirection: 'column', background: 'var(--bg)', animation: 'fadeIn 0.3s ease' },
  ...
  logoMark: { width: 36, height: 36, borderRadius: 10, background: 'var(--mint)', color: 'var(--mint-deep)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, fontWeight: 700 },
  ...
  gaugeCard: { background: 'var(--surface)', borderRadius: 'var(--radius)', padding: '20px 16px 16px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6, boxShadow: 'var(--shadow)' },
  ...
  card: { background: 'var(--surface)', borderRadius: 'var(--radius)', padding: '20px 22px', boxShadow: 'var(--shadow)' },
